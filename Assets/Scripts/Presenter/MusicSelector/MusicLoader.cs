...
namespace NoteEditor.Presenter
{
    public class MusicLoader : MonoBehaviour
    {
        ...
        {
            using (UnityWebRequest www = UnityWebRequestMultimedia.GetAudioClip("file:///" + Path.Combine(MusicSelector.DirectoryPath.Value, fileName), AudioType.WAV))
            {
                ...
                {
                    // TODO: what happens when load fails
                }
                else
                {
