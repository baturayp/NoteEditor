...
namespace NoteEditor.Presenter
{
    public class PlaybackPositionPresenter : MonoBehaviour
    {
        ...
        void Init()
        {
            ...
            Audio.TimeSamples.Select(_ => TimeSpan.FromSeconds(Audio.Source.time).ToString())
                .Where(timeInt => timeInt.IndexOf('.') > 0)
                .DistinctUntilChanged()
                .Select(elapsedTime =>
                    elapsedTime.Substring(3,8) + " / "
