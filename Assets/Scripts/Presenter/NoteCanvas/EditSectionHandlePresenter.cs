...
namespace NoteEditor.Presenter
{
    public class EditSectionHandlePresenter : MonoBehaviour
    {
        ...
        public ReadOnlyReactiveProperty<float> Position;
        ...
        void Start()
        {
            ...
            Position = lineRectTransform.ObserveEveryValueChanged(rect => rect.localPosition.x).ToReadOnlyReactiveProperty();
        }
