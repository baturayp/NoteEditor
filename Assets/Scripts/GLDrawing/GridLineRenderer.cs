                ...
                .Subscribe(_ =>
                {
                    ...
                    if (NoteCanvas.IsMouseOverNotesRegion.Value)
                    {
                        ...
                        if (distance.x < thresholdX && distance.y < thresholdY)
                        {
                            ...
                            float posText = ((float)closestLineIndex / EditData.LPB.Value / EditData.BPM.Value * 60);
                            string sec = string.Format("{0:0.00}", posText);
                            statusText.text = "Position: " + sec + " sec / " + "Line: " + closestLineIndex + " / " + "Block: " + closestBlockLindex;
                        }
                        else
                        {
